...
new_planet_mass = 0.421 * mass_jupiter/solar_mass #[solar_mass]  #NEW PLANET 
...
new_planet_dist = 290.0 #[Au]  #NEW PLANET
...
def setup():
    ...
    sim.add(m=new_planet_mass,a = new_planet_dist,e= 0.1)#x=new_planet_dist,y=0,vy=newplanet_time) #NEW PLANET
    #sim.add(m=e_planet_mass,a = e_planet_dist*1.5,e= 0.008)
    return sim
    
#time for the integration
times = np.linspace(0.,2*5000000*np.pi,1000)
print(len(times))
